...
function w3CodeColorize(x, lang, theme) {
  ...
  if (theme == "dark") {
    tagcolor = "#88ccbb";
    tagnamecolor = "#ff9999";
    attributecolor = "#c5a5c5";
    attributevaluecolor = "#88c999";
    commentcolor = "#999";
    cssselectorcolor = "#ff9999";
    csspropertycolor = "#c5a5c5";
    csspropertyvaluecolor = "#88c999";
    cssdelimitercolor = "white";
    cssimportantcolor = "#88c999";  
    jscolor = "white";
    jskeywordcolor = "#c5a5c5";
    jsstringcolor = "#88c999";
    jsnumbercolor = "#80b6ff";
    jspropertycolor = "white";
    phptagcolor = "#ff9999";
    phpcolor = "white";
    phpkeywordcolor = "#88c999";
    phpglobalcolor = "goldenrod";
    phpstringcolor = "#88c999";
    phpnumbercolor = "#88c999";  
  }
  if (!lang) {lang = "html"; }
